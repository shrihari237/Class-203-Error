...
class GUI:
	...
	def layout(self,name):
		...
		self.entryMsg = Entry(self.bottomLabel,bg="#2c3e50",fg="#EAECEE",font="Helvetica 13")
		self.entryMsg.place(relwidth=0.74,relheight=0.06,rely=0.008,relx=0.011)
		self.entryMsg.focus()

		self.buttonMsg = Button(self.bottomLabel,
						  text="Send",
		...
		self.scrollBar.place(relheight=1,relx=0.97)
